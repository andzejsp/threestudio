@echo off
set environment_path=%cd%/threestudio/env
...
if %errorlevel% equ 0 (
    ...
    python launch.py --config configs/dreamfusion-if.yaml --train --gpu 0 system.prompt_processor.prompt="green onion carving on top of a mushroom"
